...
///> Profiling stats
DECLARE_CYCLE_STAT(TEXT("CleanUpPath"), STAT_CleanUpPath, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("StringPullPath"), STAT_StringPullPath, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("SmoothPath"), STAT_SmoothPath, STATGROUP_VoidwalkerNavigation);
...
void FNavSvoUtils::StringPullPath(const FSparseVoxelOctree& Octree, TArray<FNavPathPoint>& InOutPathPoints)
{
	...
	VoidwalkerNavigation::FRaycastResult RaycastResult;
