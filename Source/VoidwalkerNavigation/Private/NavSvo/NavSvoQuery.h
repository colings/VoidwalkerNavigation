...
protected:
	bool SearchNodes(FSvoNodeLink StartNodeLink, const FVoidwalkerNavQueryFilter& InFilter, FVoidwalkerNavQueryResults& InOutResults);
...
protected:
	...
	const FVoidwalkerNavQueryFilter* Filter = nullptr;
	FVoidwalkerNavQueryResults* Results = nullptr;
};