...
// Profiling stats
DECLARE_CYCLE_STAT(TEXT("GatherGeometry (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_GatherGeometry, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("GatherGeometry : Lazy Geometry Export (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_GatherGeometry_LazyGeometryExport, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("GatherGeometry : Landscape Slices Exporting (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_GatherGeometry_LandscapeSlicesExporting, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("GatherGeometrySources (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_GatherGeometrySources, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("GatherGeometryFromSources (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_GatherGeometryFromSources, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("GatherGeometryFromSources : Landscape Slices Exporting (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_GatherGeometryFromSources_LandscapeSlicesExporting, STATGROUP_VoidwalkerNavigation);

// Memory stats
DECLARE_MEMORY_STAT(TEXT("Raw Geometry (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_RawGeometry, STATGROUP_VoidwalkerNavigation);
DECLARE_MEMORY_STAT(TEXT("Modifiers (FNavigationOctreeCollider)"), STAT_FNavigationOctreeCollider_Modifiers, STATGROUP_VoidwalkerNavigation);
...
FNavigationOctreeCollider::~FNavigationOctreeCollider()
{
	...
	DEC_DWORD_STAT_BY(STAT_VoidwalkerNavigation_TotalMemory, CulledTriangles.GetAllocatedSize());
}
...
void FNavigationOctreeCollider::GatherGeometry(UWorld* World, const FNavDataConfig& NavDataConfig, const FBox& Bounds)
{
			...
			if (NavData->IsPendingLazyGeometryGathering() || NavData->IsPendingLazyModifiersGathering())
			{
				...
				if (bSupportsSlices == true)
				{
					...
					if (NavRelevant)
					{
						...
						FVoidwalkerNavigationGeometryExport GeomExport(*NavData);
	...
	INC_DWORD_STAT_BY(STAT_VoidwalkerNavigation_TotalMemory, CulledTriangles.GetAllocatedSize());
}
