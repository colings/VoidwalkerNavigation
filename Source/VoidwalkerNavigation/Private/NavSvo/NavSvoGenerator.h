...
class VOIDWALKERNAVIGATION_API FNavSvoGenerator : public FNavDataGenerator
{
	typedef FNavDataGenerator Super;

public:
	FNavSvoGenerator(AVoidwalkerNavData* InNavDataActor);

	UWorld* GetWorld() const;
	const class FEditableSvo* GetOctree() const;
	AVoidwalkerNavData* GetNavDataActor() const { return NavDataActor; }
...
private:
	AVoidwalkerNavData* NavDataActor = nullptr;
