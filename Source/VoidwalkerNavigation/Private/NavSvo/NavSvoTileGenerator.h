...
class VOIDWALKERNAVIGATION_API FNavSvoTileGenerator : public FNoncopyable, public FGCObject
{
public:
...
class VOIDWALKERNAVIGATION_API FNavSvoTileGeneratorWrapper : public FNonAbandonableTask
{
public:
