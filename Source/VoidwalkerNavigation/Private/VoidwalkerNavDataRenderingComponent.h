...
#include "VoidwalkerNavDataRenderingComponent.generated.h"

UCLASS(hidecategories = Object, editinlinenew)
class VOIDWALKERNAVIGATION_API UVoidwalkerNavRenderingComponent : public UPrimitiveComponent
{
	GENERATED_BODY()

public:
	UVoidwalkerNavRenderingComponent();
