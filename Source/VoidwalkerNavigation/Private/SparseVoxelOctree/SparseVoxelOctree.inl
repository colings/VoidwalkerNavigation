...
DECLARE_CYCLE_STAT(TEXT("QueryNodes (FSparseVoxelOctree)"), STAT_FSparseVoxelOctree_QueryNodes, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("GetAllActiveTileCoords (FSparseVoxelOctree)"), STAT_FSparseVoxelOctree_GetAllActiveTileCoords, STATGROUP_VoidwalkerNavigation);
