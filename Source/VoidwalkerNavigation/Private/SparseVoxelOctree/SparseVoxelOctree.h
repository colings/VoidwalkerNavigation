...
class VOIDWALKERNAVIGATION_API FSparseVoxelOctree
{
...
public:
	...
	bool Raycast(const FVector& RayStart, const FVector& RayEnd, VoidwalkerNavigation::FRaycastResult& Result) const;
...
protected:
	...
	bool RaycastTile(const struct FTileRaycastInfo& Info, VoidwalkerNavigation::FRaycastResult& Result) const;
