...
// Profiling stats
DECLARE_CYCLE_STAT(TEXT("TrimExcessNodes (FSvoLayer)"), STAT_FSvoLayer_TrimExcessNodes, STATGROUP_VoidwalkerNavigation);
...
void FSvoTile::Serialize(FArchive& Ar)
{
	...
	int32 Version = Ar.CustomVer(FVoidwalkerNavigationCustomVersion::GUID);
