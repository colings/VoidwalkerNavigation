...
DECLARE_CYCLE_STAT(TEXT("RemoveTile (FEditableSvo)"), STAT_FEditableSvo_RemoveTile, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("EnsureNodeExistsAtLocation (FEditableSvo)"), STAT_FEditableSvo_EnsureNodeExistsAtLocation, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("FinalizeNodes (FEditableSvo)"), STAT_FEditableSvo_FinalizeNodes, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("FinalizeNodes : Sort (FEditableSvo)"), STAT_FEditableSvo_FinalizeNodes_Sort, STATGROUP_VoidwalkerNavigation);
DECLARE_CYCLE_STAT(TEXT("PadVoxels (FEditableSvo)"), STAT_FEditableSvo_PadVoxels, STATGROUP_VoidwalkerNavigation);
