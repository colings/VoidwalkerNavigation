...
#include "VoidwalkerNavData.generated.h"
...
class VOIDWALKERNAVIGATION_API AVoidwalkerNavData : public ANavigationData
{
	friend class UVoidwalkerNavRenderingComponent;
