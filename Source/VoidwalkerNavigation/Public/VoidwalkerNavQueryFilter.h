...
#include "VoidwalkerNavQueryFilter.generated.h"
...
enum class EVoidwalkerNavQueryFlags : uint8
{
	// Result flags
	Success				= 1 << 0,
	Failure				= 1 << 1,
...
ENUM_CLASS_FLAGS(EVoidwalkerNavQueryFlags);

struct FVoidwalkerNavQueryConstraints
{
public:
	void Reset()
	{
...
struct FVoidwalkerNavQueryResults
{
	...
	virtual ~FVoidwalkerNavQueryResults() {}
	virtual void Reset()
	{
		Status = 0;
		NumNodesQueried = 0;
...
class VOIDWALKERNAVIGATION_API FVoidwalkerNavQueryFilter : public INavigationQueryFilterInterface
{
	friend class AVoidwalkerNavData;
...
public:
	...
	FVoidwalkerNavQueryConstraints& GetConstraints() { return Constraints; }
...
private:
	...
	FVoidwalkerNavQueryConstraints Constraints;
};
